...
namespace WebAPI.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        // GET: api/Clientes
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ClienteDTO>>> GetCliente(string? cpf, string? nome, 
        ...
        string? estado, string? cidade)
        {
            ...
            if (endereco != null)
                query = query.Where(c => c.Endereco.Equals(endereco));
            if (estado != null)
            {
        ...
        public async Task<IActionResult> PutCliente(string id, ClienteDTO cliente)
        {
            ...
            clienteContext.Estado = cliente.Estado; 
         //   clienteContext.Cidade = cliente.Cidade;
